...
public class Cuadricula<TObjetoCuad> {
    ...
    public event EventHandler<OnGridObjectChangedEventArgs> CuadCambioDeObjeto;
    ...
    int ancho;
    int alto;
    private TObjetoCuad[,] matCuadricula;      //Matriz de la cuadricula
    ...
    private TextMesh[,] DebugCuadricula; //Cuadricula para poder ver los cambios de los valores
    ...
    {
        if (CuadCambioDeObjeto != null) CuadCambioDeObjeto(this, new OnGridObjectChangedEventArgs { x = x, y = y });
    }
}
